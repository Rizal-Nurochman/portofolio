/**
 * BrandIcon — inline SVGs for the three contact channels.
 * Paths from Simple Icons (CC0). currentColor so callers style via CSS.
 * ponytail: three brands only. Add a fourth? Reach for react-icons.
 */
type Name = "email" | "github" | "linkedin";
